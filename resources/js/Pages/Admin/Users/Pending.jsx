    ...
    const handleConfirm = () => {
        if (selectedUser && modalAction) {
            const routePath = modalAction === 'approve'
                ? route('admin.users.approve', selectedUser.id)
        ...
        <AdminMaster>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Pending Users</h1>
                </div>
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                                Are you sure you want to {modalAction} <span className="font-medium text-slate-700 dark:text-slate-300">"{selectedUser?.name}"</span>?
                                                <br />
